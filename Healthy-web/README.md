...
step1: install react app by npx create-react-app(you should need node_modules folder to run the code)

step2: install react router dom--- npm i react-router-dom

step3: install react icons--- npm install react-icons

step4:Do the changes in App.js

step5:clone the repository and run it(npm start)
